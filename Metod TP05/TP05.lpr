...
procedure ModificarEquipo(var Equipo:TCelular);
begin
  with Equipo do
  begin
    Write('Ingrese la marca (anterior:',Marca,') ->');
    ReadLn(Marca);

    Write('Ingrese el modelo (anterior:',Modelo,') ->');
    ReadLn(Modelo);

    Write('Ingrese el precio (anterior:',Precio:4:1,') ->');
    ReadLn(Precio);
    while(not ValidarReal(Precio)) do
      begin
        Write('Precio debe ser un numero positivo ->');
    ...
    Write('Ingrese la resolucion de la camara principal (En Mpx)(anterior:',ResCamaraPrin:4:1,')->');
    ReadLn(ResCamaraPrin);
    while(not ValidarReal(ResCamaraPrin)) do
      begin
        Write('Resolucion debe ser un numero positivo ->');
    ...
    Write('Ingrese la resolucion de la camara frontal (En Mpx) (anterior:',ResCamaraFron:4:1,')->');
    ReadLn(ResCamaraFron);
    while(not ValidarReal(ResCamaraFron)) do
      begin
        Write('Resolucion debe ser un numero positivo ->');
    ...
    Write('Ingrese el tamanio del display (en pulgadas)(anterior:',TamanioDisplay:4:1,')->');
    ReadLn(TamanioDisplay);
    while(not ValidarReal(TamanioDisplay)) do
      begin
        Write('Precio debe ser un numero positivo ->');
    ...
    Writeln('Ingrese la resolucion del display(anterior:',ResDisplay.Ancho,'x',ResDisplay.Alto,')');
    Write('(ancho)->');
    ReadLn(ResDisplay.Ancho);
    Write('(alto) ->');
    ReadLN(ResDisplay.Alto);
    ...
    Write('Ingrese la memoria interna maxima (En GB) (anterior:',MemoriaInt,')->');
    ReadLn(MemoriaInt);
    while(not ValidarGB(MemoriaInt)) do
    begin
      Write('Ingrese la memoria interna (En GB) ->');
    ...
    Write('Ingrese la memoria externa maxima (En GB) (anterior:',MemoriaExtMax,')->');
    ReadLn(MemoriaExtMax);
    while(not ValidarGB(MemoriaExtMax)) do
    begin
      Write('Ingrese la memoria externa (En GB) ->');
    ...
    Write('Ingrese el sistema operativo (anterior:',SistOp,')->');
    ReadLn(SistOp);

    Write('Ingrese la capacidad de bateria (mAh) (anterior:',CapacidadBat,')->');
    ReadLn(CapacidadBat);
    while(not ValidarEntero(CapacidadBat)) do
    begin
      Write('Capacidad incorrecta debe ser positiva ->');
...
begin
  ...
  repeat
     ...
     case Opcion of
       ...
       8:
       begin
         Writeln('Ingrese el nro de serie del equipo a modificar ->');
         ReadLn(NroSerie);
         OrdenarPorNroSerie(Celulares,N);
         IndiceBuscado := BuscarEquipoPorNroSerie(Celulares,N,NroSerie);
         if (IndiceBuscado <> -1) then
         begin
            ModificarEquipo(Celulares[IndiceBuscado]);
         end
         else
         begin
           Writeln('No se encontro el equipo');
